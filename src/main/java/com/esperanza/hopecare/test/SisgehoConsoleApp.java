...
public class SisgehoConsoleApp {
    ...
    public static void main(String[] args) {
        System.out.println("=== SISGEHO - Sistema de GestiÃ³n Hospitalaria ===\n");
        boolean salir = false;
        while (!salir) {
            mostrarMenu();
    ...
    private static void mostrarMenu() {
        System.out.println("\n--- MenÃº Principal ---");
        System.out.println("1. Registrar nuevo mÃ©dico");
        ...
        System.out.println("5. Ver Dashboard (estadÃ­sticas)");
    ...
    private static void registrarMedico() {
        ...
        System.out.print("ID de especialidad (1:Medicina General, 2:PediatrÃ­a, 3:TraumatologÃ­a): ");
        int idEsp = Integer.parseInt(scanner.nextLine());
        System.out.print("Registro mÃ©dico (ej. RM12345): ");
        String registro = scanner.nextLine();

        Medico medico = new Medico(documento, idEsp, registro);
        boolean ok = medicoDAO.insertarMedico(medico);
        if (ok) {
            System.out.println("MÃ©dico registrado exitosamente. ID Persona: " + medico.getIdPersona());
        } else {
            System.out.println("Error al registrar mÃ©dico.");
        }
    }
    ...
    private static void agendarCita() {
        ...
        System.out.print("ID del mÃ©dico: ");
    ...
    private static void procesarEntregaMedicamento() {
        ...
        System.out.print("PresentÃ³ receta (S/N): ");
