...
public class DashboardData {
    ...
    private List<RegistroItem> listaPacientes = new ArrayList<>();
    private List<RegistroItem> listaMedicos = new ArrayList<>();
    ...
    public List<RegistroItem> getListaPacientes() { return listaPacientes; }
    public void setListaPacientes(List<RegistroItem> listaPacientes) { this.listaPacientes = listaPacientes; }

    public List<RegistroItem> getListaMedicos() { return listaMedicos; }
    public void setListaMedicos(List<RegistroItem> listaMedicos) { this.listaMedicos = listaMedicos; }
}
